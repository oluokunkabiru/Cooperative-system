                  ...
                  <div class="col-lg col-md-6 ml-5">
                      ...
                      <div class="">
                          <form id="contactme" action="#" method="post">
                                      ...
                                      <div class="form-group">
                                      <label for="usr" class="text-center" >Your email address</label>
                                          <input class="form-control" type="email" name="email" placeholder="Email">
                                      </div>
                                      <div class="form-group">
                                      <label for="usr" class="text-center" >Your beautiful message</label>
                  ...
                  <div class="col-lg-6 col-md-6 footer-grid-wthree foot-top ml-4">
                      ...
                      <div class="contact-info">
                          <div class="footer-style-w3ls">
                              ...
                              <span>08130584550</span>
                          </div>
                          <div class="footer-style-w3ls my-4">
                              <h4 class=" mb-2">Email </h4>
                              <span>kaoluokun@student.lautech</span>
                          </div>
                          <div class="footer-style-w3ls">
                          ...
                          <table class="ml-5 mr-3">
                            ...
                            <td><a href="#" ><span class="mx-2"><i class="fab fa-facebook" style="font-size: 30px"></i></span></a></td>
                            <td><a href="#" ><span  class="mx-2"><i class="fab fa-whatsapp" style="font-size: 30px"></i></span></a></td>
                            <td><a href="#" ><span class="mx-2"><i class="fab fa-twitter" style="font-size: 30px"></i></span></a></td>
                            <td><a href="#" ><span  class="mx-2"><i class="fab fa-instagram" style="font-size: 30px"></i></span></a></td>
                               </tr>
                        </table>
                      </div>
                  </div>
